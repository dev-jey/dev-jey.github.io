                    ...
                    <div class="container">
                        ...
                        <div class="row text-center mx-auto mb-5">
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fab fa-python fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fab fa-js fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fab fa-java fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fas fa-database fa-5x"></i></div>
                        ...
                        <div className="row mx-auto text-center">
                            <div class="col-lg-3 col-md-6">
                                <div class="icon mb-3"><i class="fab fa-aws fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fab fa-bootstrap fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fas fa-users-cog fa-5x"></i></div>
                            ...
                            <div class="col-lg-3 col-md-6 ">
                                <div class="icon mb-3"><i class="fas fa-cube fa-5x"></i></div>
